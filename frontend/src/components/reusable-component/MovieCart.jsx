...
const MovieCart = ({movie,hamburgerClicked}) => {
  useEffect(() => {
  ...
  return (
       ...
       <div className="w-full  h-[300px] sm:h-[500px] lg:p-10 rounded-md transition-transform duration-300 hover:scale-105 hover:shadow-xl hover:shadow-[#00aaff66]" {...(!hamburgerClicked&&{'data-aos':'zoom-in'})}>
